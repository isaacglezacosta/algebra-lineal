...
def sistema_ecuaciones(a11, a12, a21, a22, b1, b2, x, y, x1, x2, y1, y2, determinante):
    determinante = (a22 * a11 - a12 * a21)
...
sistema_ecuaciones(a11, a12, a21, a22, b1, b2, x, y, x1, x2, y1, y2, determinante)